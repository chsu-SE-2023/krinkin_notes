...
namespace DataBaseApp
{
    public partial class Form1 : Form
    {
        ...
        {
            InitializeComponent();
            this.buttonChoose.Image = IconExtractor.Extract(@"C:\Windows\System32\imageres.dll", -3)?.ToBitmap();
            ...
            this.buttonHistorySave.Image = IconExtractor.Extract(@"C:\Windows\System32\shell32.dll", -16761)?.ToBitmap();
        }
        ...
        private void buttonChoose_Click(object sender, EventArgs e)
        {
            ...
            {
                this.Text = "Access Editor ("+openFileDialog1.FileName+")";
                buttonOpen.Enabled = true;
                buttonClose_Click(sender, e);

                history($"Выбран файл {openFileDialog1.FileName}");
            }
        }
        ...
        private void buttonOpen_Click(object sender, EventArgs e)
        {
            ...
            {
                database = new Database(openFileDialog1.FileName);
