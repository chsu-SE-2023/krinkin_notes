...
private:
	...
	System::Void GUI_Load(System::Object^ sender, System::EventArgs^ e) {
		...
		this->dataGridViewKeys->Columns[0]->HeaderCell->Value = "Лексема";
		this->dataGridViewKeys->Columns[1]->HeaderCell->Value = "Код";
		this->dataGridViewConst->Columns[0]->HeaderCell->Value = "Лексема";
		this->dataGridViewConst->Columns[1]->HeaderCell->Value = "Код";
	}
};
}
