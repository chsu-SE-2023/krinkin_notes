...
class Tests {
private:
    const std::vector<double> packets = {15.6};
    const std::array<int, 32> clients = {1, 2, 3};
    const std::array<int, 5> address = {10, 11, 12, 13, 14};
    const int connected = 3;
    const std::string ssid = "CoolWLAN";
    const std::string passwd = "qwerty123";
